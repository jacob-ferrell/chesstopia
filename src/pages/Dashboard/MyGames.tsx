...
export default function MyGames({ classNames }: MyGamesProps) {
  ...
  function renderGames() {
    const gamesSorted = (games as Game[]).sort(sortByIsTurn);
  ...
  function getMostRecentMove(moves: Move[]): Move | undefined {
  ...
  function sortByIsTurn(a: Game, b: Game): number {
    const isTurn = (game: Game) => game.currentTurn.id === user!.id;
    return (isTurn(b) ? 1 : 0) - (isTurn(a) ? 1 : 0);
  }
